...
//else{
  	  	...
  	  	String sql="insert into xuanzeti(zhuanye,xueke,timu,xuanxiangA,xuanxiangB,xuanxiangC,xuanxiangD,daan,nanduxishu,questionType) values('"+zhuanye+"','"+xueke+"','"+timu+"','"+xuanxiangA+"','"+xuanxiangB+"','"+xuanxiangC+"','"+xuanxiangD+"','"+daan+"','"+nanduxishu+"','"+questtype+"') ";
